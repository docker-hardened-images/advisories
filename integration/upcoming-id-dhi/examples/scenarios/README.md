...
| `under_investigation` with language component context | [alpine-python-component](alpine-python-component/) | `CVE-2025-12781` is conservatively discoverable from DHI OSV while Python VEX marks the assessment unresolved; `pkg:pypi/setuptools@58.3.0` remains component context. |
