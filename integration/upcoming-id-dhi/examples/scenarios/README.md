...
| `under_investigation` with language component provenance | [alpine-python-component](alpine-python-component/) | DHI OSV lists `python-3.12@3.12.13-r7` as affected without defining a range, while Python VEX marks the assessment unresolved. `pkg:pypi/setuptools@58.3.0` remains provenance in fixture metadata and the SBOM, outside the OSV/VEX payloads. |
