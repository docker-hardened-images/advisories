...
1. **[FAQ](../docs/faq.md)** - Common issues and solutions
2. **[Troubleshooting Guide](../docs/faq.md#troubleshooting)** - Debugging tips
...
- 🌳 Study [Decision Trees](../docs/decision-trees.md)
