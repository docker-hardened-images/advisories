...
| `under_investigation` with language component context | [alpine-python-component](alpine-python-component/) | The exact `python-3.12@3.12.13-r7` version is conservatively discoverable from DHI OSV without a range while Python VEX marks the assessment unresolved; `pkg:pypi/setuptools@58.3.0` remains component context. |
